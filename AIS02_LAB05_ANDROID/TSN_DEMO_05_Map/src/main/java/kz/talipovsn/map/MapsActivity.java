...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    static final LatLng startMarker = new LatLng(52.25305381727632, 76.94710400940401); // Начальный маркер
    static final LatLng marker1 = new LatLng(52.25247819224632, 76.94867001276388); // Маркер 42 школа
    static final LatLng marker2 = new LatLng(52.25569996859948, 76.94020290317881); // Маркер 4 поликлиника
    static final LatLng marker3 = new LatLng(52.24950042858874, 76.95357472334194); // Маркер Мечта
    static final LatLng marker4 = new LatLng(52.253794429857685, 76.94243866356244); // Маркер НИШ
    static final LatLng marker5 = new LatLng(52.253671318109895, 76.94571618964012); // Маркер Кардиоцентр
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        mMap.addMarker(new MarkerOptions().position(marker1).title(getString(R.string.marker1_title)).icon(
                BitmapDescriptorFactory.fromResource(R.drawable.fourty_two)).alpha(ALPHA).
        ...
        mMap.addMarker(new MarkerOptions().position(marker2).title((getString(R.string.marker2_title))).icon(
                BitmapDescriptorFactory.fromResource(R.drawable.ambulance_four)).alpha(ALPHA).
        ...
        mMap.addMarker(new MarkerOptions().position(marker3).title((getString(R.string.marker3_title))).icon(
                        BitmapDescriptorFactory.fromResource(R.drawable.mechta)).alpha(ALPHA).
        ...
        mMap.addMarker(new MarkerOptions().position(marker4).title((getString(R.string.marker4_title))).icon(
                        BitmapDescriptorFactory.fromResource(R.drawable.nis)).alpha(ALPHA).
        ...
        mMap.addMarker(new MarkerOptions().position(marker5).title((getString(R.string.marker5_title))).icon(
                        BitmapDescriptorFactory.fromResource(R.drawable.cardio_hospital)).alpha(ALPHA).
